...
public class Router_old {
	...
	*/
	public Router_old(IUnknown pIOCM, String args[]) {
		runtime = pIOCM;
		printBanner();
	}
	...
	*/
	...
	public static void main(String[] args) {
		...
		try{
			String APP_PATH = "C:\\rajiv\\AODVOverlay\\";
			String cfgInfoFile; 
	        ...
	        // --- send some data to another node -----
	        // this will initiate route discovery if no active route to destination
